...
*   Risk allocation: traditional Public-Private Partnership models shift infrastructure project risks from the government to the private partner.
...
*Click here to download the [PDF version](https://github.com/david-chi-zhang/MReview/raw/master/_posts/pdf/202205_PEPPP.pdf)*
...
![Fig1](https://david-chi-zhang.github.io/MReview/img/20220516/Fig1.png)
...
**This is the classic "Investment Hold-up**" problem in economics (see Grossman and Hart (1986 [^9]) and Che & Sákovics (2018 [^10]). When deciding whether to participate in infrastructure projects, potential private partners foresee the sequential gaming process, take into account the risks posed by the government, and choose either to demand higher yields or simply back out.&#x20;
...
**CDB's urban lending model around the 2000s had the following features.** [^11]
